function output = estimatesnr(options, inputdata)
...
theestimatesnr = apps.EstimateSNR(args);
...
% Run the procedure
theestimatesnr.initDefaultVals();
theestimatesnr.initVariables();
theestimatesnr.execute(om);
