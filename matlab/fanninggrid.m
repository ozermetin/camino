function output = fanninggrid(options, inputdata)
...
thefanninggrid = apps.FanningGrid(args);
...
% Run the procedure
thefanninggrid.initDefaultVals();
thefanninggrid.initVariables();
thefanninggrid.execute(om);
