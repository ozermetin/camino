function output = datasynth(options, inputdata)
...
thedatasynth = apps.SyntheticData(args);
...
% Run the procedure
thedatasynth.initDefaultVals();
thedatasynth.initVariables();
thedatasynth.execute(om);
