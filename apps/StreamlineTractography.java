 ...
 *
 * @author Philip Cook
 * @version $Id: StreamlineTractography.java 1160 2012-12-12 17:43:16Z ucacpco $
 *
 */
public class StreamlineTractography extends Executable {
    ...
    public void initOptions(String[] args){
        ...
        if (CL_Initializer.inputModel.equals("wildbs_dt")) {
            imageType = ImageType.WILDBS_DT;
            CL_Initializer.inputDataType = "float";
        }
        else if (CL_Initializer.inputModel.equals("repbs_dt")) {
            imageType = ImageType.REPBS_DT;
            CL_Initializer.inputDataType = "float";
        }
        else if (CL_Initializer.inputModel.equals("repbs_multitensor")) {
            imageType = ImageType.REPBS_MULTITENSOR;
            CL_Initializer.inputDataType = "float";
        }
            ...
            imageType = ImageType.DT;
        }
        else if (CL_Initializer.inputModel.equals("multitensor")) {
            imageType = ImageType.MULTITENSOR;
        }
        else if (CL_Initializer.inputModel.equals("sfpeak")) {
            imageType = ImageType.SF_PEAK;
        }
        else if (CL_Initializer.inputModel.equals("dwi_dt")) {
            imageType = ImageType.DWI_DT;
            CL_Initializer.inputDataType = "float";
        }
        else if (CL_Initializer.inputModel.equals("dwi_multitensor")) {
            imageType = ImageType.DWI_MULTITENSOR;
            CL_Initializer.inputDataType = "float";
        }
            ...
            CL_Initializer.inputDataType = "float";
            imageType = ImageType.BAYESDIRAC;
        }
        else if (CL_Initializer.inputModel.equals("bayesdirac_dt")) {
            
            // uses raw data
            CL_Initializer.inputDataType = "float";
            imageType = ImageType.BAYESDIRAC_DT;
        }
        else {
    ...
    public void execute(OutputManager om) {
        ...
        if (CL_Initializer.voxelClassMap != null) {
            ...
            VoxelOrderDataSource vcSource = new VoxelOrderDataSource(CL_Initializer.voxelClassMap, 1, "int");
