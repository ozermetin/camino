 ...
 * 
 */
public class TensorGDRCylindersDotLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public TensorGDRCylindersDotLM_Fitter() {
	}
	 ...
	 */
	public TensorGDRCylindersDotLM_Fitter(DW_Scheme scheme) {
	...
	protected void makeCodec() {
		cod = new Codec() {
			...
			public double[] optToModel(double[] optParams) {
				...
				modelParams[3] = 1 - f - tensf; // volume fraction of dot	
	...
	public static void main(String[] args) {
		...
		TensorGDRCylindersDotLM_Fitter inv = new TensorGDRCylindersDotLM_Fitter(
