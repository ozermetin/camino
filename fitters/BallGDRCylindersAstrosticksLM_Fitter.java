 ...
 * 
 */
public class BallGDRCylindersAstrosticksLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public BallGDRCylindersAstrosticksLM_Fitter() {
	}
	 ...
	 */
	public BallGDRCylindersAstrosticksLM_Fitter(DW_Scheme scheme) {
	...
	protected void makeCodec() {
		cod = new Codec() {
			...
			public double[] modelToOpt(double[] modelParams) {
				...
				optParams[4] = (Math.acos(Math
						.sqrt((modelParams[5] - 1e-7) / 20e-6)));// beta
			...
			public double[] optToModel(double[] optParams) {
				...
				//modelParams[5] = optParams[4] * optParams[4]; // beta 
	...
	public static void main(String[] args) {
		...
		BallGDRCylindersAstrosticksLM_Fitter inv = new BallGDRCylindersAstrosticksLM_Fitter(
