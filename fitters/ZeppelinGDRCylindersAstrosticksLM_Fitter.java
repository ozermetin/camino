 ...
 * 
 */
public class ZeppelinGDRCylindersAstrosticksLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public ZeppelinGDRCylindersAstrosticksLM_Fitter() {
	}
	 ...
	 */
	public ZeppelinGDRCylindersAstrosticksLM_Fitter(DW_Scheme scheme) {
	...
	public static void main(String[] args) {
		...
		ZeppelinGDRCylindersAstrosticksLM_Fitter inv = new ZeppelinGDRCylindersAstrosticksLM_Fitter(
