 ...
 * @version $Id: VoxelOrderDataSource.java 1020 2012-01-17 21:19:19Z ucacpco $
 *  
 */
public class VoxelOrderDataSource extends ExternalDataSource {
    ...
    public double[][][][] getVoxelsDoubleArray(int[] dataDims) {
		// TODO Auto-generated method stub
    	double[][][][] voxelData = new double[dataDims[0]][dataDims[1]][dataDims[2]][numComponents];
    	try{
    	for(int z=0;z<dataDims[2];z++)
    		for(int y=0;y<dataDims[1];y++)
    			for(int x=0;x<dataDims[0];x++)
    			{
    				double[] componentData = this.nextVoxel();
    				voxelData[x][y][z]=componentData;
    			}
    	}
    	catch(DataSourceException ex)
    	{
    		System.err.println("End of DataSource!!!");
    	}
    	if(this.more())
    		System.err.println("Datasource Not Fully Readed!!! ");
    	return voxelData;
	}
