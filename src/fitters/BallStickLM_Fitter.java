 ...
 *
 */
public class BallStickLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public BallStickLM_Fitter(DW_Scheme scheme) {
	 ...
	 */
	public BallStickLM_Fitter(DW_Scheme scheme, String[] compNames,
	...
	public static void main(String[] args) {
		...
		BallStickLM_Fitter inv = new BallStickLM_Fitter(
