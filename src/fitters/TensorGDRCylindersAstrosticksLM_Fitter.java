 ...
 * 
 */
public class TensorGDRCylindersAstrosticksLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public TensorGDRCylindersAstrosticksLM_Fitter() {
	}
	 ...
	 */
	public TensorGDRCylindersAstrosticksLM_Fitter(DW_Scheme scheme) {
	...
	public static void main(String[] args) {
		...
		TensorGDRCylindersAstrosticksLM_Fitter inv = new TensorGDRCylindersAstrosticksLM_Fitter(
