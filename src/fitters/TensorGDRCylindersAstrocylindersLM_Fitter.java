 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the tensor and gamma distributed radii cylinders model using one run of a Levenburg Marquardt.
 * 
 * <dt>Description:
 * 
 ...
 * 
 */
public class TensorGDRCylindersAstrocylindersLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public TensorGDRCylindersAstrocylindersLM_Fitter() {
	}
	 ...
	 */
	public TensorGDRCylindersAstrocylindersLM_Fitter(DW_Scheme scheme) {
		...
		cod = new Codec() {
			...
			public double[] optToModel(double[] optParams) {
				...
				* Math.sin(optParams[8]);//diff perp constrained
				...
				modelParams[13] = Math.sin(optParams[9])
				* Math.sin(optParams[9]);//diff perp constrained
				...
				modelParams[16] = modelParams[4] * modelParams[5];//R 
	...
	public static void main(String[] args) {
		...
		TensorGDRCylindersAstrocylindersLM_Fitter inv = new TensorGDRCylindersAstrocylindersLM_Fitter(
