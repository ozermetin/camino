 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the ball and gamma distributed radii cylinders model using one run of a Levenburg Marquardt.
 * 
 * <dt>Description:
 * 
 ...
 * 
 */
public class BallGDRCylindersAstrocylindersLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public BallGDRCylindersAstrocylindersLM_Fitter() {
	}
	 ...
	 */
	public BallGDRCylindersAstrocylindersLM_Fitter(DW_Scheme scheme) {
	...
	protected void makeCodec() {
		cod = new Codec() {
			...
			public double[] modelToOpt(double[] modelParams) {
				...
				optParams[2] = Math.acos(Math.sqrt(modelParams[2]/(1-modelParams[1]))); // f extra
			...
			public double[] optToModel(double[] optParams) {
				...
				modelParams[11] = modelParams[4]*modelParams[5]; // R set as k*beta 
	...
	public static void main(String[] args) {
		...
		BallGDRCylindersAstrocylindersLM_Fitter inv = new BallGDRCylindersAstrocylindersLM_Fitter(
