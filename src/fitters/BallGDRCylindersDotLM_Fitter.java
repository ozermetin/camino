 ...
 * 
 */
public class BallGDRCylindersDotLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public BallGDRCylindersDotLM_Fitter() {
	}
	 ...
	 */
	public BallGDRCylindersDotLM_Fitter(DW_Scheme scheme) {
	...
	public static void main(String[] args) {
		...
		BallGDRCylindersDotLM_Fitter inv = new BallGDRCylindersDotLM_Fitter(
