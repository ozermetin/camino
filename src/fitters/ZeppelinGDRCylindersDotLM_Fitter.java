 ...
 * 
 */
public class ZeppelinGDRCylindersDotLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public ZeppelinGDRCylindersDotLM_Fitter() {
	}
	 ...
	 */
	public ZeppelinGDRCylindersDotLM_Fitter(DW_Scheme scheme) {
	...
	public static void main(String[] args) {
		...
		ZeppelinGDRCylindersDotLM_Fitter inv = new ZeppelinGDRCylindersDotLM_Fitter(
