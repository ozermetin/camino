...
public class CrossingCylinderSubstrate extends CylinderSubstrate {
	...
	public CrossingCylinderSubstrate(SimulationParams simParams){
		super(new double[]{SimulationParams.sim_cyl_R, 
		                   2.0*SimulationParams.sim_cyl_R, 
		                   SimulationParams.sim_cyl_R}, simParams, false);
    ...
    public boolean crossesMembrane(Walker walker, double[] rawOffset, double[] rawStep,
        ...
        for(int i=0; i<cylinder.length; i++){
            ...
            // check the cylinders
            if(cylinder[i].crosses(walkerPos, step, normal, d, skip, origLength, intDist, intIn, intP)){
