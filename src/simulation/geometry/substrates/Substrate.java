...
public abstract class Substrate{
     ...
     */
    private final void assembleSubVoxelList(double[] subsCoords, double[] step){
...
*/        
    ...
    protected static final void testBoundaryIntersection(){
        ...
        SimulationParams.sim_cyl_R=4E-6;
        SimulationParams.sim_cyl_r=1E-6;
