...
public class BasicCylinder implements Cylinder, SubstrateObject{
	 ...
	 * @param d space to stor distance from origin in normal direction
	 * @param origLength the length of the original step
	 * @param intDist space to store arclength to intersection point
	 * @param in space to store if walker was initially in or out of cylinder
	 * @param p space to store permeability fo cylinder if intersection
	 * 
	...
	public boolean crosses(double[] rawPos, double[] rawStep,
		...
		if((d1<=r)&&(d2<=r)){
			// we're inside the circle, just check the chords and go
	 ...
	 */
	private final double clamp(double x, double A, double B){
	...
	public static final void testArbOrientation(){
	    ...
	    boolean crosses= bc.crosses(walkerPos, step, normal, d, false, 1E-6, intDist, in, p);
	    ...
	    crosses= cyl.crosses(walkerPos, step, normal, d, false, 1E-6, intDist, in, p);
	...
	public static final void testAnnoyingCase(){
        ...
        boolean crosses= bc9.crosses(walkerPos, step, normal, d, false, 1E-6, intDist, in, p);
        ...
        crosses= bc5.crosses(walkerPos, step, normal, d, false, 1E-6, intDist, in, p);
