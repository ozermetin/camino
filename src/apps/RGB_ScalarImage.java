...
public class RGB_ScalarImage {
     ...
     */
    public static RGB_ScalarImage imageFromSphFuncPDs(VoxelOrderDataSource data, ImageHeader ih, double[][][] scalars, 
						      double minScalar, double maxScalar) {
     ...
     */
    public static RGB_ScalarImage imageFromBallStick(VoxelOrderDataSource data, ImageHeader ih, double[][][] scalars, 
						      double minScalar, double maxScalar) {
    ...
    public static RGB_ScalarImage imageFromCompartmentModel(ImageHeader ih, 
        ...
        VoxelOrderDataSource data = new VoxelOrderDataSource(CL_Initializer.inputFile, valsPerVoxel, CL_Initializer.inputDataType);
     ...
     * is used.
     */
    public static RGB_ScalarImage imageFromTensorEigenSys(VoxelOrderDataSource data, ImageHeader ih, 
