...
import statistics.DirectionalStatistics;
...
public class EntryPoint {
	...
	private static Executable getExecutable(String execname, String[] newArgs){
		...
		if(execname.equalsIgnoreCase("StreamlineTractography")){
			return new StreamlineTractography(newArgs);
		}
		else if(execname.equalsIgnoreCase("AddNoise")){
...
/*		else if(execname.equalsIgnoreCase("RGB_ScalarImage")){
		...
		else if(execname.equalsIgnoreCase("DirectionalStatistics")){
			return new DirectionalStatistics(newArgs);
			
		}
		else if(execname.equalsIgnoreCase("DirectionalAnalysis")){
			return new DirectionalAnalysis(newArgs);
		}
